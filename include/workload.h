 ...
 * cenários/seeds no mesmo processo nunca faz uma sequência interferir na
 * outra.
 */
typedef struct {
 ...
 * processos, em ordem não decrescente, começando em t >= 0.
 *
...
/*
 * Parâmetros da geração de carga. Todas as faixas são inclusivas nos dois
 * extremos.
 */
typedef struct {
 ...
 * desse.
 *
 * Retorna 0 em sucesso e -1 se os parâmetros forem inválidos ou a alocação
