...
int main(void) {
    ...
    puts("Workload: chegadas não decrescentes"); fflush(stdout);
    test_arrivals_non_decreasing();
    puts("Workload: média zero chega toda no instante 0"); fflush(stdout);
    ...
    puts("Carga completa: faixas de parâmetros e IDs respeitados"); fflush(stdout);
    ...
    puts("Carga completa: parâmetros inválidos são rejeitados"); fflush(stdout);
